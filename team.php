	...
	<div class="photoWrapperMain">
        <div class="photoWrapper">
            ...
            <div class="card">
                <div class="imageContaner">
                    <div class="details2">
                        <h3 class="devName">Ronaldino Kaunang</h3>
                        <p class="devDes">NIM - 230211060103</p>
                    </div>
                    <img class="devImage" src="resources/images/developers/Dino.jpg" alt="">
                </div>
                <div class="details"></div>
            </div>
            <div class="card">
                <div class="imageContaner">
                    <div class="details2">
                        <h3 class="devName">Natasha Pangemanan</h3>
                        <p class="devDes">NIM - 230211060013</p>
                    </div>
                    <img class="devImage" src="resources/images/developers/Natasha.jpg" alt="">
                </div>
                <div class="details"></div>
            </div>
            <div class="card">
                <div class="imageContaner">
                    <div class="details2">
                        <h3 class="devName">Emmanuela Michiko</h3>
                        <p class="devDes">NIM - 230211060027</p>
                    </div>
                    <img class="devImage" src="resources/images/developers/Michiko.jpg" alt="">
                </div>
                <div class="details"></div>
            </div>
        </div>
