...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Generic function to handle popup display
    function showPopup(btn, index, popupOverlay, popupImage, popupTitle, popupDescription) {
        const card = btn.closest(".card");
        const title = card.querySelector("h1").innerText;
        const imageSrc = card.querySelector("img").getAttribute("src");
        let description = btn.getAttribute('data-description') || '';

        // For Row 1 (hardcoded descriptions)
    ...
    // Row 1 popup description
    btns.forEach((btn, index) => {
        btn.addEventListener("click", function() {
            showPopup(this, index, popupOverlay, popupImage, popupTitle, popupDescription);
        });
    });
    ...
    btns2.forEach((btn, index) => {
        btn.addEventListener("click", function(e) {
            ...
            // Hardcoded descriptions for static content
            if (!description) {
                switch (index) {
                    case 0:
            ...
            popupImage2.style.backgroundImage = `url('${imageSrc}')`; // Ensure proper URL formatting
            popupTitle2.innerText = title;
            popupDescription2.innerText = description || 'No description available';
    ...
    btns3.forEach((btn, index) => {
        btn.addEventListener("click", function() {
            ...
            popupDescription3.innerText = description || 'No description available';
    ...
    btns4.forEach((btn, index) => {
        btn.addEventListener("click", function() {
            ...
            popupDescription4.innerText = description || 'No description available';
    ...
    btns5.forEach((btn, index) => {
        btn.addEventListener("click", function() {
            ...
            popupDescription5.innerText = description || 'No description available';
